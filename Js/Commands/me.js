...
module.exports.run = async (bot, message, args) => {
    ...
    const botEmbed = new discord.RichEmbed()
        ...
        .addField("**Joind Server At**", `${moment.utc(message.member.joinedAt).format("DD MMM YYYY")}`, true)
        .addField("**Joind Discord At**", `${moment.utc(user.createdAt).format("DD MMM YYYY")}`, true)
